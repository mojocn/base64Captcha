...
var errOfNewStore error

func init(){
	globalStore, errOfNewStore = NewGlobalStore("redis", storeConfig{expire:60, limitNumber:10240, extraConfig:"127.0.0.1:6379"})
	if errOfNewStore != nil {
		panic("create 'redis' globalstore failed")
	}
}
